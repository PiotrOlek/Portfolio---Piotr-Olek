...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#002222] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='text-white border-2 hover:bg-[#85C75A] hover:border-[#85C75A] px-4 py-3 my-8 mx-auto flex items-center'>Wspólnie działajmy!</button>
        </form>
    </div>
  )
}
